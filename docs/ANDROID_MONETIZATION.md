...
The same version 1.5 / version code 2 build that Play already accepted can discover this product dynamically; no new binary is required solely to expose Remove Ads.

Billing purchase/restore behavior still must be validated using a Play-delivered internal-test build rather than a sideloaded APK.
